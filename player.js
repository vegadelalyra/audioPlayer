...
//Events and functionalities on images
var title = document.querySelector("#plays"); //This is the title of the audio player
var disk = document.querySelector("#audioPlayer"); //This is the audio player feature
...
epic.addEventListener("click",(e)=>{
    ...
    disk.src="/playlists/epic/Ultra Instinct - Dragon Ball Super.mp3";
    disk.play();
});
...
mind.addEventListener("click",(e)=>{
    ...
    epic.addEventListener("mouseout",fireOff);
    cool.addEventListener("mouseout",chillOff);
    title.textContent = `chill playlist`;
});
